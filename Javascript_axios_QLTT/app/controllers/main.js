...
function layDuLieuDauVao(isAdd) {
  ...
  isValid &=
    validation.kiemTraRong(hoTen, "errhoten", "(*) Họ tên không được trống") &&
    validation.kiemTraKyTuChuoi(hoTen, "errhoten", "(*) Họ tên phải là chữ");
  ...
  isValid &=
    validation.kiemTraRong(email, "erremail", "(*) Email không được trống") &&
    validation.kiemTraEmail(email, "erremail", "(*) Email không đúng");

  isValid &= validation.kiemTraRong(hinhAnh, "errhinhanh", "gõ ảnh vào");
...
function capNhatND(id) {
  var user = layDuLieuDauVao(false)
